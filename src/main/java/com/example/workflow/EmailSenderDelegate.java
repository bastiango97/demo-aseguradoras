...
public class EmailSenderDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        String bodyClient = "<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;\">"
                ...
                + "<a href=\"https://demo-ventas-camunda.onrender.com/complete-task/accept/" + userTaskId + "\" style=\"background-color: #28a745; color: white; padding: 15px 30px; border-radius: 5px; text-decoration: none; margin: 10px; display: inline-block;\">Aceptar Cotización</a>"
                + "<a href=\"https://demo-ventas-camunda.onrender.com/complete-task/reject/" + userTaskId + "\" style=\"background-color: #dc3545; color: white; padding: 15px 30px; border-radius: 5px; text-decoration: none; margin: 10px; display: inline-block;\">Rechazar Cotización</a>"
                + "<a href=\"https://demo-ventas-camunda.onrender.com/complete-task/request-changes/" + userTaskId + "\" style=\"background-color: #ffc107; color: white; padding: 15px 30px; border-radius: 5px; text-decoration: none; margin: 10px; display: inline-block;\">Solicitar Cambios</a>"
                + "</div>"
